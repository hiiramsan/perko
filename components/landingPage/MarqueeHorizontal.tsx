...
const reviews = [
  ...
  {
    name: "Jullian Puerta",
    title: "Director de marca, Mercado Oak Street",
    body:
...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative flex h-full w-72 cursor-pointer flex-col overflow-hidden rounded-2xl border p-5 shadow-sm",
